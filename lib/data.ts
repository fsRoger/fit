...
export const INITIAL_PANTRY: PantryItem[] = [
  ...
  // Adicionar ao final do INITIAL_PANTRY:
  {
    id: "p19",
    name: "Cuscuz (fubá)",
    qty: 500,
...
export const INITIAL_RECIPES: Recipe[] = [
  ...
  // Adicionar ao final do INITIAL_RECIPES:
  {
    id: "r11",
    ...
    rating: 5,
    ingredients: [
      { pantryId: "p19", name: "Cuscuz (fubá)", amount: 100, unit: "g" },
      { pantryId: "p3", name: "Peito de frango", amount: 120, unit: "g" },
      { pantryId: "p4", name: "Ovos", amount: 1, unit: "un" },
      { pantryId: "p10", name: "Azeite", amount: 5, unit: "ml" },
    ],
    instructions: [
      "Hidrate o cuscuz com água quente e sal, tampe por 5 minutos.",
      "Grelhe o frango em tiras temperado com alho e sal.",
      "Frite o ovo na frigideira com azeite.",
      "Solte o cuscuz com um garfo e sirva com frango e ovo por cima.",
    ],
  },
  {
    id: "r12",
    name: "Tapioca com Atum e Queijo Cottage",
    calories: 340,
    protein: 32,
    carbs: 36,
    fat: 7,
    ...
    rating: 5,
    ingredients: [
      { pantryId: "p21", name: "Goma de tapioca", amount: 80, unit: "g" },
      { pantryId: "p9", name: "Atum em lata", amount: 1, unit: "lata" },
      { pantryId: "p24", name: "Queijo cottage", amount: 50, unit: "g" },
    ],
    instructions: [
      "Espalhe a goma de tapioca em frigideira antiaderente seca e quente.",
      "Tampe e deixe firmar por 2 minutos (sem óleo).",
      "Recheie com atum escorrido e queijo cottage.",
      "Dobre ao meio e sirva imediatamente.",
    ],
  },
  {
    id: "r13",
    name: "Frango com Mandioca Cozida",
    calories: 510,
    protein: 40,
    carbs: 54,
    fat: 9,
    ...
    ingredients: [
      { pantryId: "p3", name: "Peito de frango", amount: 150, unit: "g" },
      { pantryId: "p20", name: "Mandioca", amount: 200, unit: "g" },
      { pantryId: "p10", name: "Azeite", amount: 10, unit: "ml" },
      { pantryId: "p11", name: "Alho", amount: 5, unit: "g" },
    ],
    instructions: [
      "Cozinhe a mandioca em água com sal por 20 minutos até ficar macia.",
      "Tempere o frango com alho, sal e pimenta.",
      "Grelhe o frango com azeite por 7 min de cada lado.",
      "Sirva o frango sobre a mandioca cozida e regue com um fio de azeite.",
    ],
  },
  {
    id: "r14",
    name: "Cuscuz com Leite e Banana (Café)",
    calories: 370,
    protein: 14,
    carbs: 64,
    fat: 5,
    ...
    instructions: [
      "Hidrate o cuscuz com leite morno ao invés de água.",
      "Tampe e aguarde 5 minutos para o leite ser absorvido.",
      "Solte com garfo e sirva com a banana fatiada por cima.",
    ],
  },
  {
    id: "r15",
    name: "Sardinha com Batata-Doce Assada",
    calories: 420,
    protein: 34,
    carbs: 44,
    fat: 10,
    ...
    rating: 4,
    ingredients: [
      { pantryId: "p25", name: "Sardinha em lata", amount: 1, unit: "lata" },
      { pantryId: "p6", name: "Batata-doce", amount: 200, unit: "g" },
      { pantryId: "p10", name: "Azeite", amount: 5, unit: "ml" },
    ],
    instructions: [
      "Corte a batata-doce em rodelas e tempere com azeite e sal.",
      "Asse no forno a 200°C por 25 minutos.",
      "Escorra e tempere a sardinha com limão e pimenta.",
      "Sirva as rodelas de batata com a sardinha por cima.",
    ],
  },
  {
    id: "r16",
    name: "Tapioca com Ovo Mexido e Banana",
    calories: 350,
    protein: 18,
    carbs: 50,
    fat: 8,
    ...
    instructions: [
      "Faça a tapioca em frigideira seca e quente.",
      "Mexa os ovos temperdos com sal em outra frigideira.",
      "Recheie a tapioca com os ovos mexidos.",
      "Sirva com banana fatiada ao lado.",
    ],
  },
  {
    id: "r17",
    name: "Mandioca com Carne Moída Refogada",
    calories: 530,
    protein: 36,
    carbs: 56,
    fat: 14,
    ...
    ingredients: [
      { pantryId: "p20", name: "Mandioca", amount: 200, unit: "g" },
      { pantryId: "p16", name: "Carne moída", amount: 130, unit: "g" },
      { pantryId: "p10", name: "Azeite", amount: 10, unit: "ml" },
      { pantryId: "p11", name: "Alho", amount: 5, unit: "g" },
    ],
    instructions: [
      "Cozinhe a mandioca em água com sal por 20 min e escorra.",
      "Refogue o alho no azeite, adicione a carne moída e tempere.",
      "Cozinhe a carne até dourar, cerca de 8 minutos.",
      "Sirva a mandioca com a carne moída por cima.",
    ],
  },
  {
    id: "r18",
    name: "Shake de Amendoim com Banana e Whey",
    calories: 430,
    protein: 34,
    carbs: 44,
    fat: 12,
    ...
    rating: 5,
    ingredients: [
      { pantryId: "p22", name: "Amendoim torrado", amount: 30, unit: "g" },
      { pantryId: "p7", name: "Banana", amount: 1, unit: "un" },
      { pantryId: "p15", name: "Whey Protein", amount: 30, unit: "g" },
      { pantryId: "p8", name: "Leite desnatado", amount: 200, unit: "ml" },
    ],
    instructions: [
      ...
      "Consuma antes do treino para energia e proteína.",
    ],
  },
];
